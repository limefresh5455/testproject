<script>
  export let IsShowClassDetails;
  export let handleBackToCalendarClick;
</script>

<div class="bcxform4" class:hidden={!IsShowClassDetails} id="formbcxmain4">
  <div class="detail-top-main">
    <div class="reserve-form-main payment_option">
          ...
          <div class="form__group">
            <div class="form__radio-group">
              <input
                ...
                name="payment"
              />
              <label for="credit_card" class="form__radio-label">
                <span class="form__radio-button"></span>
                <span class="form__radio-label-text"
                  >Credit/Debit Cards<span></span></span
                ></label
              >
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="payment_input">
              ...
              <ul>
                ...
                <li><img src="assets/img/amex.svg" /></li>
                <li><img src="assets/img/discover.svg" /></li>
              </ul>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group mb-3 mb-md-0">
                <label>Country</label>
                <select class="country form-control" name="">
                  <option name=""> Country </option>
                  <option name=""> Country1 </option>
                  <option name=""> Country2 </option>
                  <option name=""> Country3 </option>
                  <option name="3"> Country4 </option>
                  <option name=""> Country5 </option>
                </select>
              </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              <div class="btn-bcx">
                ...
                >
                <a href="#" class="pay_btn">Pay $ 100.00 <span>USD</span></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form__group">
          <div class="form__radio-group">
            <input
              ...
              name="payment"
            />
            <label for="credit_account" class="form__radio-label">
              <span class="form__radio-button"></span>
              <span class="form__radio-label-text">
                Credit Account<span></span></span
              ></label
            >
          </div>
        </div>
        ...
        <div class="form__group">
          <div class="form__radio-group">
            <input
              ...
              name="payment"
            />
            <label for="pass" class="form__radio-label">
              <span class="form__radio-button"></span>
              <span class="form__radio-label-text"
                >Yoga Class Pass<span></span></span
              ></label
            >
          </div>
        </div>
        ...
        <div class="form__group">
          <div class="form__radio-group">
            <input
              ...
              name="payment"
            />
            <label for="pay_later" class="form__radio-label">
              <span class="form__radio-button"></span>
              <span class="form__radio-label-text">Pay Later<span></span></span
              ></label
            >
          </div>
        </div>
