...
$(document).ready(function () {
    ...
    $(".yer").each(function () {
        if (Number($(this).text()) === currentYear) {
    ...
    $(".mon").each(function () {
        if ($(this).attr("name") === String(currentMonth)) {
            $(this).prop("selected", true);
        }
    });
    ...
    $(".date__number").each(function () {
        ...
        if (testId && testId.startsWith("Next")) {
            
            return;
        }

        var selectedYear = Number($(".year option:selected").text());
        var selectedMonth = Number($(".month option:selected").attr("name"));
        var dateNumber = Number($(this).text());

        if (
            (selectedYear < currentYear) || 
            (selectedYear === currentYear && selectedMonth < currentMonth) || 
            (selectedYear === currentYear && selectedMonth === currentMonth && dateNumber < currentDay)
        ) {
            $(this).addClass("disable");
        } else if (selectedYear === currentYear && selectedMonth === currentMonth && dateNumber === currentDay) {
            $(this).addClass("date__number--true");
        }
    });


    $(".choosen").text(currentDay + '.' + currentMonth + '.' + currentYear);


    $(".date").click(function () {
        var day = $(".date__number--true").text();
...
//         scrollToForm();
//     });
//     $(".date__number.disable").click(function () {
//         $(".calendar").hide();
//         $(".bcxform1").show();
//         scrollToForm();
//     });

//     $("#toselectedClass1,#toselectedClass2,#toselectedClass3").click(function () {
//         $(".calendar").hide();
//         $("#selectClasses").hide();
//         $("#formbcxmain1").show();
//         scrollToForm();
